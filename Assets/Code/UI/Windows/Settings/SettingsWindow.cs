...
namespace Code.UI.Windows.Settings
{
    public class SettingsWindow : WindowBase
    {
        ...
        public void SetupButtons()
        {
            ...
            SoundButton.Construct(new SmartSoundToggleCommand(_soundService, new PlaySoundCommand(_soundService, SoundButton.GetComponent<ButtonSFX>().SoundId)), _soundService);
            MusicButton.Construct(new CompositeCommand(new ToggleCommand(_musicService), new PlaySoundCommand(_soundService, MusicButton.GetComponent<ButtonSFX>().SoundId)), _musicService);
